...
from bento.services.php import php_service_for, php_runner_service_for
from bento.utils.errors import info, warn
from bento.utils.paths import CRON_RUNTIME_DIR, GENERATED_NOTICE, RenderContext
...
17 3 * * * /usr/sbin/logrotate -s /var/lib/logrotate/bento-{runner_service}.status /usr/local/etc/php/cron.d/.logrotate.conf
""")
