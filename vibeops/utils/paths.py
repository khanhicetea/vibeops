...
# vibeops/utils/paths.py -> repo root is two parents up
...
GENERATED_MANAGED_GLOBS = (
    ...
    "cron/php*/.supercronic.cron",  # legacy shared scheduler; removed on next render
...
class RenderContext:
    ...
    def mysql_root_option_file(self, service: str) -> Path:
        from vibeops.utils.validation import MYSQL_SERVICE_RE, validate
