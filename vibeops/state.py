...
from vibeops.paths import DB_PATH, LEGACY_DB_PATH, LEGACY_PHP_VERSIONS_DIR, NGINX_VHOST_DIR, PHP_VERSIONS_DIR, SCHEMA_VERSION, STATE_DIR, now, rel
from vibeops.validation import default_php_entrypoint, validate_php_entrypoint, validate_public_dir
