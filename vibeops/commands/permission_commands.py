...
from vibeops.services.php import php_cli_service_for, php_service_for
from vibeops.os.process import docker_available, run, service_running
from vibeops.services.state import load_db
from vibeops.utils.validation import APP_NAME_RE, PHP_VERSION_RE, validate
