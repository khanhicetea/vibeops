...
- [x] App/proxy desired-state removal requires exact `delete <slug>` confirmation; CLI-only `app prune` lists retained home/database parts and requires typing literal `delete` with no bypass flag
