...
from vibeops.table import format_table, print_table, terminal_width, truncate_cell


class TerminalWidthTests(unittest.TestCase):
    def test_uses_shutil_get_terminal_size(self) -> None:
        with mock.patch("vibeops.table.shutil.get_terminal_size") as gts:
...
class FormatTableTests(unittest.TestCase):
    ...
    def test_print_table_uses_info_and_prefix(self) -> None:
        out = io.StringIO()
        with mock.patch("vibeops.table.terminal_width", return_value=80):
