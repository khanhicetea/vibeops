...
from vibeops.commands import app_config_commands
from vibeops.commands.parser import build_parser
from vibeops.services import app_config, nginx, php
...
class AppConfigCustomizationTests(unittest.TestCase):
    ...
    def test_install_preserves_existing_source_unless_forced(self) -> None:
        ...
        self.assertTrue(created)
        self.assertIn("VIBEOPS CUSTOM APP TEMPLATE", path.read_text())
    ...
    def test_custom_vhost_template_is_rendered_with_state_and_tls(self) -> None:
        ...
        self.assertIn("GENERATED BY VIBEOPS", text)
    ...
    def test_custom_pool_template_is_rendered_to_selected_php_version(self) -> None:
        ...
        self.assertTrue(text.startswith("; GENERATED BY VIBEOPS"))
